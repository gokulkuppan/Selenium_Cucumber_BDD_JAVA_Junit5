...
public class BrowserUtils {
    ...
    public static void verifyElementDisplayed(By by) {
        try {
            Assertions.assertTrue(Driver.get().findElement(by).isDisplayed(), "Element not visible: " + by);
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assertions.assertFalse(Driver.get().findElement(by).isDisplayed(), "Element should not be visible: " + by);
        } catch (NoSuchElementException e) {
            e.printStackTrace();
    ...
    /**
     * Robust click method - waits for element to be clickable, scrolls to it, then clicks
     * @param element
     */
    ...
    /**
     * Robust sendKeys method - waits for element to be visible, scrolls to it, then sends keys
     * @param element
     * @param text
     */
    ...
    /**
     * Robust clear method - waits for element to be visible, scrolls to it, then clears
     * @param element
     */
    ...
    /**
     * Enhanced clearAndSendKeys with waiting and scrolling
     * @param element
     * @param text
     */
    public static void clearAndSendKeysRobust(WebElement element, String text) {
        clear(element);
     ...
     * @param element - the select dropdown element
